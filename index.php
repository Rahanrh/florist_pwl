  ...
  <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item" data-bs-interval="2000">
        <a href="home/shop.php"><img src="img/carousel/dadi2.jpg" class="d-block w-100" alt="..."></a>
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item" ata-bs-interval="2000">
        <a href="home/shop.php"><img src="img/carousel/dadi3.jpg" class="d-block w-100" alt="..."></a>
        <div class="carousel-caption d-none d-md-block">
  ...
  <section id="shop">
    <div class="container">
      <div class="row mt-3">
        ...
        $query = mysqli_query($koneksi, "SELECT prodak_bunga.*,SUM(total_bunga_terjual) AS sold FROM prodak_bunga JOIN total_bunga_terjual ON total_bunga_terjual.id_bunga = prodak_bunga.id_bunga GROUP BY total_bunga_terjual.id_bunga HAVING sold >= 30 ORDER BY sold DESC LIMIT 4");
        $result = mysqli_fetch_all($query, MYSQLI_ASSOC);
