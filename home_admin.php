...
<body id="home">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="registeradmin.php">Registrasi Admin</a></li>
              ...
              <li class="nav-item active" style="margin-left: 10px;">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="history_pembayaran.php">History Pembayaran</a></li>
                  </ul>
                </div>
              </li>
            </ul>
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href="registeradminl.php">Register Admin</a>
          </li> -->
          <!-- <li class="nav-item">
  ...
  <section id="Shop">
    <div class="container">
      ...
      $tanggalSekarang = date_format($date, "Y-m-d H:i:s");

      // require_once 'koneksi.php';
      // pemanggilan koneksi sekali saja
      // date_default_timezone_set('Asia/Jakarta');
      // $tanggalSekarang = date_format(new DateTime(), "Y-m-d H:i:s");
      $query = mysqli_query($koneksi, "SELECT * FROM prodak_bunga JOIN produk_flashsale ON prodak_bunga.id_bunga = produk_flashsale.id_bunga JOIN flash_sale ON produk_flashsale.id_flash_sale = flash_sale.id_flash_sale WHERE '$tanggalSekarang' BETWEEN flash_start and flash_end");
      ...
      <div class="row ">
        <div class="row ">
          <div class="col mt-4">
            <h2 class="p1 text-center">CHRISTMAS SPECIAL EDITION FLASH SALE</h2>
            <a href="admin/flashsale/index.php" class="btn btn-success">FlashSale</a>
            <a href="admin/produk_flashsale/index.php" class="btn btn-success ">Product FlashSale</a>
          </div>
        </div>
          ...
          <div class="col-md-3 mt-3">
            <div class="card">
              <a href='detail_bouquet.php?id_bunga=<?= $result['id_bunga']; ?>'>
                <img src="img/prodak/bouquet/<?php echo $result['gb_bunga']; ?>" class="card-img-top" alt=""></a>
              <div class="card-body">
                <label class="card-tittle fs-6 p1"><strong class="p1">Nama Bunga : </strong><?php echo $result['nama_bunga']; ?></label><br>
                <label class="card-text harga"><strong class="p1">Rp. </strong><?php echo number_format($result['harga']); ?></label>
                <label class="card-tittle fs-6 p1"><strong class="p1">Flash Start : </strong><?php echo $result['flash_start']; ?></label><br>
                <label class="card-tittle fs-6 p1"><strong class="p1">Flash End : </strong><?php echo $result['flash_end']; ?></label><br>
                <!-- protocol://domain/segment/file.php?data1=dummydata -->

                <a href="hapus_flashsale.php?id_bunga=<?php echo $result["id_bunga"];  ?>" class="btn btn-danger mt-2">Hapus</a>
    ...
    <div class="d-grid gap-6 col-3 mx-auto mt-3">
      <a href="christmas.php" class="btn btn-warning">VIEW CATALOG</a>
    </div>
  </section>
  <!-- AKHIR SPECIAL EDITION -->
      ...
      <div class="row mt-3">
        ...
        ?>
          <div class="col-md-3 mt-3">
            <div class="card">
              <a href='detail_bouquet.php?id_bunga=<?= $result['id_bunga']; ?>'>
                <img src="img/<?= $result['gb_bunga'] ?>" class="card-img-top" alt=""></a>
              <div class="card-body">
        ...
        ?>
          <div class="col-md-3 mt-3">
            <div class="card">
              ...
              <div class="card-body">
                <h1 class="card-tittle fs-6 p1"><?= $result['nama_bunga'] ?></h1>
                <label class="card-tittle fs-6 p1"><?= $result['sold'] ?></label><strong class="p1"> Sold </strong><br>
              </div>
            </div>
          </div>
        <?php endforeach;
